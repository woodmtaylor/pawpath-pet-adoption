...
1. [Core Tables](#core-tables)
   ...
   - [Shelter](#shelter)
   - [Pet](#pet)
2. [Pet Management Tables](#pet-management-tables)
   - [Pet_Trait](#pet_trait)
   - [Trait_Category](#trait_category)
   - [Pet_Trait_Relation](#pet_trait_relation)
   - [Pet_Image](#pet_image)
3. [Adoption System Tables](#adoption-system-tables)
   - [Adoption_Application](#adoption_application)
   - [Application_Document](#application_document)
4. [Quiz System Tables](#quiz-system-tables)
...
6. [Content Management Tables](#content-management-tables)
   - [Blog_Post](#blog_post)
   - [Product](#product)
   - [Blog_Product_Relation](#blog_product_relation)
7. [Administrative Tables](#administrative-tables)
   - [ShelterStaff](#shelterstaff)
   - [RoleChangeLog](#rolechangelog)
   - [PasswordReset](#passwordreset)
8. [Views](#views)
   - [vw_shelter_staff](#vw_shelter_staff)
9. [Triggers](#triggers)
   - [before_user_role_update](#before_user_role_update)
10. [Sample Data Queries](#sample-data-queries)
